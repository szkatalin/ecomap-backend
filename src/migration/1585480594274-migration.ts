...
export class migration1585480594274 implements MigrationInterface {
  name = 'migration1585480594274';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "address" ("id" SERIAL NOT NULL, "country" character varying NOT NULL, "postalCode" integer NOT NULL, "city" character varying NOT NULL, "coordinates" double precision array, "recommendedPlaceId" integer, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`,
      undefined
    );
    await queryRunner.query(
